...
BEGIN
    ...
    -- 2. Transferring Users to DimUserProfiles
    ...
    -- 3. Transferring Categories to DimCategories
    ...
    -- 4. Transferring FlavorProfiles to DimFlavorProfiles
    ...
    -- 5. Transferring Origins to DimOrigin
    ...
    -- 6. Transferring Products to DimProducts
    ...
    -- 7. Transferring Suppliers to DimSuppliers
    ...
    -- 8. Transferring Dates to DimDate
    ...
    -- 9. Transferring Orders to FactOrders
    ...
    -- 10. Transferring Reviews to FactReviews
    ...
    -- 11. Transferring ProductSuppliers to FactProductSupplier
    ...
    -- 12. Transferring ProductViews to FactProductView
    ...
    -- 13. Transferring Wishlists to DimWishlist and FactWishlistItem
